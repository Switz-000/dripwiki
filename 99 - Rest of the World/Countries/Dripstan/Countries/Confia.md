...
However, this was the only social program launched by the government, due to the climate of austerity following the recently defeated rampant inflation. Kunsekowić refused to add further expenses he deemed unnecessary, citing the poor state of the economy and saying that "we need to cook the stew in the big pot before serving it to the pots." There was an attempt, albeit unsuccessful, to remove the GANTAR program, which was maintained through a hard struggle by the progressive wings of the KNP.
