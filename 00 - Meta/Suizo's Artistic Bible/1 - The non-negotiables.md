These are rules, not preferences. They bind every choice.
...
4. **Intellectual capture is everywhere.** Institutions metabolize ideas — including their own opposition — into fuel. The strongest version of capture is not silencing; it is the system where every move by the captured party feeds the capturer.
   
5. **The gap between intention and implementation is the story.** What a thing meant to be and what it became are rarely the same. The distance between them is where the meaning lives.
   
6. **Apply the sensibility; never narrate it.** Produce material that _has_ the property. Do not name the theme. Trust the reader to feel it. Naming it is the single most common way to ruin it.