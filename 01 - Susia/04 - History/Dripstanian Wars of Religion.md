...
When Agamilos succeeded his brother [[Saint Emperor Mantichev]] in 1686, the empire was divided among many churches and denominations, each practicing a markedly different form of Armotism.

## The wars

The wars were not a single continuous conflict. Across 47 years the imperial army, dukes loyal to the crown and religious militias fought peasant revolts, movements condemned as heretical, and rebellious duchies, some of which allied with Konph states.

%% TODO: the campaigns, their dates, the named leaders on either side, the Konph states involved, and how the period ended are not established. %%

## Religious settlement

Agamilos brought the three largest denominations into a single church. The three were centered on [[Piyejňe]] in [[Postia]], [[Kruie ro Yietre]] in [[Vitrika]] and [[Poremoj]] in [[Dripia]]. Under the settlement the emperor became head of the church, and a single body of eleven justices was established to rule on the official interpretation of the Holy [[Ladan]].
...
- "Holy Ladan" follows the author. [[Sacoitism]] records the [[Ladan]] as a shared scripture whose Armotist and Sacoitist versions are disputed; which version the body interpreted is not stated.
- The war type has no template. Fields beyond the base header are limited to the date pair.
- Links to pages that do not exist: [[Ladan]], [[Doremojism]]. [[Piyejňe]], [[Kruie ro Yietre]] and [[Poremoj]] have frontmatter only.
