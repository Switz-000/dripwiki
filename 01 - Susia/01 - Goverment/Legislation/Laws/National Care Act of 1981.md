...
Enrollment of a state's residents in the program satisfies that state's constitutional obligation to provide access to healthcare.
...
- Constitutional authorization: the Act is presented as resting on the federal taxation and spending power. The constitution does not enumerate a federal healthcare power, and Article I assigns the duty to states. The exact authorizing clause should be specified when the Susian Constitution article is drafted.
